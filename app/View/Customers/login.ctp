          ...
          <div class="col-md-9 col-sm-9">
            ...
            <div class="content-form-page">
              <div class="row">
				...
				<?php echo $this->Form->create('Customer',array('class'=>'form-horizontal form-without-legend')); ?>
                    <div class="form-group">
                      <label for="email" class="col-lg-4 control-label">Email <span class="require">*</span></label>
                      <div class="col-lg-8">
					  <?php echo $this->Form->input('email', array('type'=>'text','class'=>'form-control','placeholder'=>'Enter your Email','label'=>false,'type'=>'email')); ?>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-8">
					   <?php echo $this->Form->input('password', array('type'=>'text','class'=>'form-control','placeholder'=>'Enter your Password','label'=>false,'type'=>'password')); ?>
                      </div>
                    </div>
                    <div class="row">
